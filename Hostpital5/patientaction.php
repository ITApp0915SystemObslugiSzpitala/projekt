...
if ($_POST["button"]=="Aktualizuj"){
 ...
 /*$db->query("UPDATE addresses  SET street_number = '".$_POST['ud_street_number']."', street_name = '".$_POST['ud_street_name']."', city = '".$_POST['ud_city']."', postal_code = '".$_POST['ud_postal_code']."',  country = '".$_POST['ud_country']."';");
...
echo "INSERT INTO diagnoses (record_item_id, diagnose_code, comment_id, created_by_user_id, created_on_date ) values ('".$_GET['recordid']."', '".$_POST['diagnose_code']."', '".$kom."', '".$_SESSION['id']."','".date('Y-m-d H:m:s')."');";
//$_SESSION['message'] = '<div class="alert alert-success" role="alert">Pacjent o id: '.$_GET['patient'].' został przyjęty na oddział '.$_POST['ward_id'].' . </div>';
//header ('Location: searchwynik.php');
 }
$db->close();
