...
if ($_POST["button"]=="Wstaw"){
 ...
 $db->query("INSERT INTO addresses (street_name, street_number, city,  postal_code, country, modified_by_user_id, created_by_user_id, created_on_date ) values ('".$_POST['street_name']."', '".$_POST['street_number']."', '".$_POST['city']."', '".$_POST['postal_code']."', '".$_POST['country']."',  '".$_SESSION['id']."', '".$_SESSION['id']."', '".date('Y-m-d H:m:s')."');");
