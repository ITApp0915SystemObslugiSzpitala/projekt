...
$('[data-toggle="popover"]').popover();
  ...
  <select id="role" name="role" class="form-control" placeholder="Podaj rolę" autocomplete="off"  data-toggle="popover" onClick=pop()  data-content="Podaj rolę">
  
  <option value="2">Lekarz/Lekarka</option>
  <option value="2">Pielęgniarz/Pielęgniarka</option>
  <option value="2">Administrator/Administratorka</option>
