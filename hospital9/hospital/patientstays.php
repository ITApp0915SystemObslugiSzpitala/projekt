...
echo '<div class="row">
        <div class="col-md-6">
          <table class="table">
			...
			<tbody>';
$result = $db->query("SELECT patient_records.*, record_items.*  FROM patient_records, record_items where record_items.patient_stay_id='".$_GET['id']."' AND patient_records.patient_record_id = record_items.patient_record_id");
//echo  "SELECT patient_records.*, record_items.*  FROM patient_records, record_items where record_items.patient_stay_id='".$_GET['id']."' AND patient_records.patient_record_id = record_items.patient_record_id";
