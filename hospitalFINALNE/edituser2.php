...
while($row = $result->fetch_assoc()){
  ...
  <input type="ud_password" id="ud_password" name="ud_password" class="form-control" value="'.$row{'password'}.'" autocomplete="off" data-toggle="popover" onClick=pop()  data-content="Wprowadź hasło"></div>
  <div class="input-group">
...
?></div>
  ...
  $result2 = $db->query("SELECT addresses.* FROM addresses where user_id=".$_GET['id']."  ");
