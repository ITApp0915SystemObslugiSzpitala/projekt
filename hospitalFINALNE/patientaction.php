...
$sdid = $db->insert_id;
$db->query("INSERT INTO patient_drugs ( symptom_drug_id, patient_id, comment, created_by_user_id, created_on_date ) values ('".$sdid."', '".$_GET['patient']."', '".$kom."', '".$_SESSION['id']."','".date('Y-m-d H:m:s')."');");
echo "INSERT INTO patient_drugs ( symptom_drug_id, patient_id, comment, created_by_user_id, created_on_date ) values ('".$sdid."', '".$_GET['patient']."', '".$kom."', '".$_SESSION['id']."','".date('Y-m-d H:m:s')."');";
