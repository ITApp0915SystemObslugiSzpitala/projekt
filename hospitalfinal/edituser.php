...
while($row = $result->fetch_assoc()){
  ...
  <input type="int" name="ud_user_id" id="ud_user_id" class="form-control" value="'.$row{'user_id'}.'" autocomplete="off" data-toggle="popover" onClick=pop()  data-content="Wprowadź imie użytkownika(Max 45 znaków)"></div>
  ...
  <div class="input-group">
  <span class="input-group-addon">Hasło<span style="color: red">*</span></span>
  <input type="text" id="ud_password" name="ud_password" class="form-control" value="'.$row{'password'}.'" autocomplete="off" data-toggle="popover" onClick=pop()  data-content="Wprowadź nazwisko użytkownika(Max 45 znaków)"></div>
  <div class="input-group">
