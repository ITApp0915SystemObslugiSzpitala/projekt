...
$szukaj = $db->query( "SELECT addresses.*, address_id FROM addresses, patient_addresses WHERE patient_id=".$_GET['id']."");

echo "SELECT addresses.*, address_id FROM addresses, patient_addresses WHERE patient_id=".$_GET['id']."";

while($row = $szukaj->fetch_assoc()){
/*$wynik=mysql_query($szukaj) or die(mysql_error());*/
...
<a href="editpatient.php?id=<?php echo $_GET['id'];?>" class="btn btn-primary btn-lg">Edytuj</a>
